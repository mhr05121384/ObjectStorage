...
set(aws-c-auth_INCLUDE_DIRS ${aws-c-auth_INCLUDE_DIRS_RELEASE} )
set(aws-c-auth_INCLUDE_DIR ${aws-c-auth_INCLUDE_DIRS_RELEASE} )
set(aws-c-auth_LIBRARIES ${aws-c-auth_LIBRARIES_RELEASE} )
set(aws-c-auth_DEFINITIONS ${aws-c-auth_DEFINITIONS_RELEASE} )


# Only the last installed configuration BUILD_MODULES are included to avoid the collision
foreach(_BUILD_MODULE ${aws-c-auth_BUILD_MODULES_PATHS_RELEASE} )
