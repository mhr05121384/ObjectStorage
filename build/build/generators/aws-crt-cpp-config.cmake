...
set(aws-crt-cpp_INCLUDE_DIRS ${aws-crt-cpp_INCLUDE_DIRS_RELEASE} )
set(aws-crt-cpp_INCLUDE_DIR ${aws-crt-cpp_INCLUDE_DIRS_RELEASE} )
set(aws-crt-cpp_LIBRARIES ${aws-crt-cpp_LIBRARIES_RELEASE} )
set(aws-crt-cpp_DEFINITIONS ${aws-crt-cpp_DEFINITIONS_RELEASE} )


# Only the last installed configuration BUILD_MODULES are included to avoid the collision
foreach(_BUILD_MODULE ${aws-crt-cpp_BUILD_MODULES_PATHS_RELEASE} )
