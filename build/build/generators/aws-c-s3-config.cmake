...
set(aws-c-s3_INCLUDE_DIRS ${aws-c-s3_INCLUDE_DIRS_RELEASE} )
set(aws-c-s3_INCLUDE_DIR ${aws-c-s3_INCLUDE_DIRS_RELEASE} )
set(aws-c-s3_LIBRARIES ${aws-c-s3_LIBRARIES_RELEASE} )
set(aws-c-s3_DEFINITIONS ${aws-c-s3_DEFINITIONS_RELEASE} )


# Only the last installed configuration BUILD_MODULES are included to avoid the collision
foreach(_BUILD_MODULE ${aws-c-s3_BUILD_MODULES_PATHS_RELEASE} )
